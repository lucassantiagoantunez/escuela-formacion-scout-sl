...
from .seguridad import MaterialEditorialForm, NoticiaEditorialForm
import csv
...
class MaterialAdmin(admin.ModelAdmin):
    form = MaterialEditorialForm

    def get_readonly_fields(self, request, obj=None):
        return () if request.user.is_superuser else ('programas', 'areas_programa')
